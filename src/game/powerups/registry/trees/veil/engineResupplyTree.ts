...
export const engineResupplyTree: PowerupNodeDefinition[] = [
  /* ─────────────── Root ─────────────── */
  {
    ...
    label: 'Engine Drop I',
    description: 'Receive 3 random Tier 1 engine blocks.',
    icon: 'icon-resupply-crate',
    category: 'engine-resupply',
    parentId: null,
    exclusiveBranchKey: 'engine-resupply',
    metadata: { grantEngineBlocks: { tier: 2, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 2 ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 2 engine blocks.',
    icon: 'icon-resupply-crate',
    category: 'engine-resupply',
    parentId: 'engine-resupply-1',
    metadata: { grantEngineBlocks: { tier: 3, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 3 ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 3 engine blocks.',
    icon: 'icon-resupply-crate',
    category: 'engine-resupply',
    parentId: 'engine-resupply-2',
    metadata: { grantEngineBlocks: { tier: 4, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 4 ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 4 engine blocks.',
    icon: 'icon-resupply-crate',
    category: 'engine-resupply',
    parentId: 'engine-resupply-3',
    metadata: { grantEngineBlocks: { tier: 5, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 5 sequence ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 5 engine blocks.',
  ...
  },
  {
    ...
    description: 'Receive 3 additional random Tier 5 engine blocks.',
    icon: 'icon-resupply-elite',
    category: 'engine-resupply',
