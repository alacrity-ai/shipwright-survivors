...
export const weaponResupplyTree: PowerupNodeDefinition[] = [
  /* ─────────────── Root ─────────────── */
  {
    ...
    label: 'Weapon Drop I',
    description: 'Receive 3 random Tier 2 weapon blocks.',
    icon: 'icon-weapon-crate',
    category: 'weapon-resupply',
    parentId: null,
    exclusiveBranchKey: 'weapon-resupply',
    metadata: { grantWeaponBlocks: { tier: 2, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 2 ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 3 weapon blocks.',
    icon: 'icon-weapon-crate',
    category: 'weapon-resupply',
    parentId: 'weapon-resupply-1',
    metadata: { grantWeaponBlocks: { tier: 3, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 3 ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 4 weapon blocks.',
    icon: 'icon-weapon-crate',
    category: 'weapon-resupply',
    parentId: 'weapon-resupply-2',
    metadata: { grantWeaponBlocks: { tier: 4, count: 3 } },
    channel: 'veil',
  },
  ...
  /* ─────────────── Tier 4 ─────────────── */
  {
    ...
    description: 'Receive 3 random Tier 5 weapon blocks.',
    icon: 'icon-weapon-crate',
    category: 'weapon-resupply',
    parentId: 'weapon-resupply-3',
    metadata: { grantWeaponBlocks: { tier: 5, count: 3 } },
    channel: 'veil',
  },
  ...
  },
  {
    ...
    description: 'Receive 3 additional random Tier 5 weapon blocks.',
    icon: 'icon-weapon-elite',
    category: 'weapon-resupply',
