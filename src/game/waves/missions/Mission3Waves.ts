...
export const waveDefinitions: WaveDefinition[] = [
  {
    ...
    ships: [
      ...
      { shipId: 'mission_03/haloblade_beatle_00', count: 2, hunter: true },
      { shipId: 'mission_03/haloblade_beatle_01', count: 4 },
      { shipId: 'mission_03/lance_miner_00', count: 8, hunter: true },
  ...
  },
  {
    ...
    ships: [
      ...
      { shipId: 'mission_03/haloblade_speeder_00', count: 6, hunter: true },
